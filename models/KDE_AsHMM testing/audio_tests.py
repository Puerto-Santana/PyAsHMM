...
model_perros2 = KDE_AsHMM(train_dog,3)
model_perros2.SEM()
...
print("perros-perros")
print(model_perros2.log_likelihood(test_dog[0], xunit=True))
print(model_perros2.log_likelihood(test_dog[1], xunit=True))
print(model_perros2.log_likelihood(test_dog[2], xunit=True))
print(model_perros2.log_likelihood(test_dog[3], xunit=True))
print("perros-gatos")
print(model_perros2.log_likelihood(test_cat[0], xunit=True))
print(model_perros2.log_likelihood(test_cat[1], xunit=True))
print(model_perros2.log_likelihood(test_cat[2], xunit=True))
print(model_perros2.log_likelihood(test_cat[3], xunit=True))
